...
Understand your office's performance at a glance
      ...
      <div className="print-only-report">
        <div className="print-header">
          ...
          <div className="print-subtitle">Performance Overview and Request Analytics</div>
        ...
        <div className="print-stats-grid">
          <div className="print-stat-box">
            <div className="print-stat-label">Total Requests</div>
            <div className="print-stat-value">{analytics.total}</div>
          </div>
          <div className="print-stat-box">
            <div className="print-stat-label">Avg Resolution Time</div>
            <div className="print-stat-value">{analytics.avgResolutionTime}</div>
          </div>
          <div className="print-stat-box">
            <div className="print-stat-label">Cancelled Rate</div>
            <div className="print-stat-value">{analytics.cancelledRate}%</div>
          </div>
        </div>

        <div className="print-section">
          <div className="print-section-title">Status Breakdown</div>
        ...
        {topSubjects.length > 0 && (
          <div className="print-section">
            <div className="print-section-title">Top Request Subjects</div>
            <table className="print-table">
              <thead>
                <tr>
                  <th>Rank</th>
        ...
        {staffActivity.length > 0 && (
          <div className="print-section">
            <div className="print-section-title">Staff Activity</div>
            <table className="print-table">
              <thead>
                <tr>
                  <th>Staff Member</th>
        ...
        {recentTickets.length > 0 && (
          <div className="print-section">
            <div className="print-section-title">Recent Requests</div>
            <table className="print-table">
              <thead>
                <tr>
                  <th>Request ID</th>
